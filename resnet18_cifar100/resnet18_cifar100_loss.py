...
sgdm_file = open('./SGDM/SGDM_loss_200_epochs_lr=1e-1_wd=5e-4_cosine1000_resnet18_cifar100.pkl', 'rb')
adam_file = open('./Adam/Adam_loss_200_epochs_lr=1e-3_wd=0_cosine1000_resnet18_cifar100.pkl', 'rb')
inverse_adam_if_file = open('./InverseAdam_IF/InverseAdam_IF_loss_200_epochs_lr=1e-2_sr=8e-5_wd=1e-2_cosine1000_resnet18_cifar100.pkl', 'rb')
inverse_adam_af_file = open('./InverseAdam_AF/InverseAdam_AF_loss_200_epochs_lr=1e-2_sr1e-5_wd=1e-2_cosine1000_resnet18_cifar100.pkl', 'rb')
# adamw_lr1en2_file = open('./AdamW/AdamW_accuracy_200_epochs_lr=1e-2_wd=1e-2_cosine1000_resnet18_cifar100.pkl', 'rb')
adamw_lr1en3_file = open('./AdamW/AdamW_loss_200_epochs_lr=1e-3_wd=1e-2_cosine1000_resnet18_cifar100.pkl', 'rb')
ar_inverse_adam_file = open('./AR_InverseAdam/ARInverseAdam_loss_200_epochs_lr=1e-2_sr=1e-4_wd=1e-2_cosine1000_resnet18_cifar100.pkl', 'rb')
