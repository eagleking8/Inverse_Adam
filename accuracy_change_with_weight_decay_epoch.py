...
# plt.plot(epoch, y_inverse_adam_wd3en9_accuracy, linewidth=1, linestyle="solid", label="inverse_adam wd=3e-9", color='pink')
# plt.plot(epoch, y_inverse_adam_wd5en9_accuracy, linewidth=1, linestyle="solid", label="inverse_adam wd=5e-9", color='orange')
# plt.plot(epoch, y_inverse_adam_wd1en2_accuracy, linewidth=1, linestyle="dotted", label="inverse_adam wd=1e-2", color='red')
