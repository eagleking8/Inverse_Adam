...
if __name__ == '__main__':
    ...
    # 保存准确率到文件
    with open('SGD_accuracy_200_epochs_lr=1e-1_momentum=0_wd=5e-4_cosine1000_resnet18_cifar10.pkl', 'wb') as file:
        pickle.dump(accuracies, file)

    # 保存损失到文件
    with open('SGD_loss_200_epochs_lr=1e-1_momentum=0_wd=5e-4_cosine1000_resnet18_cifar10.pkl', 'wb') as file:
